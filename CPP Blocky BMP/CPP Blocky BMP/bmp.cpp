...
bool Bmp::write(const string &fileName, string &errMsg) const
{
   ...
   int fileSize =
      mWidth * mHeight * 3 +
      Bmp::FILE_HEADER_SIZE + Bmp::INFO_HEADER_SIZE;
   ...
   int offset = Bmp::FILE_HEADER_SIZE + Bmp::INFO_HEADER_SIZE;
   doWrite(out, offset);
   ...
   int headerSize = Bmp::INFO_HEADER_SIZE;
